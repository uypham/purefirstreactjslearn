...
class Homepage extends Component {
    ...
    onSubmitForm(e) {
        e.preventDefault();
        let ten = this.refs.inputTen.value;
        let lop = this.refs.inputLop.value;
        if (!ten) {
        ...
        this.setState(prevState => {
            let locthu = prevState.lophoc.find(x => x.name == ten && x.grade == lop);
            console.log(locthu);
            if (locthu) { return { lophoc: prevState.lophoc } }
            // ...
            return {
    ...
    render() {
        ...
        let datalophoc = this.state.lophoc.sort((a, b) => a.name.toLowerCase() > b.name.toLowerCase());
        return (
